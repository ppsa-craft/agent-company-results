...
- [DEV] [vnstock-advisor] tasks/vnstock-advisor-5-dev-analysis-engine.md — status: ready
- [TESTER] [vnstock-advisor] tasks/vnstock-advisor-6-tester-data-ingest.md — status: claimed:tester
