...
The nightly `apps CI` full audit (decision #137) found `apps/json-formatter` failing its build/test on `main` — a regression in ALREADY-SHIPPED work, not part of any in-progress task. Full run: https://github.com/ppsa-craft/agent-company-results/actions/runs/31564177653
