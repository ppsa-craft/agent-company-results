...
- `vnstock-advisor-5-dev-analysis-engine` (must be at least code-complete with README)
- Runs in parallel with: `vnstock-advisor-6-tester-data-ingest`
- **BLOCKED** until `vnstock-advisor-3-ba-analysis-engine` completes (needs specs for test basis)